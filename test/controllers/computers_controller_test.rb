...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { college: @computer.college, idf: @computer.idf, lab: @computer.lab, name: @computer.name, os: @computer.os, scep: @computer.scep } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { college: @computer.college, idf: @computer.idf, lab: @computer.lab, name: @computer.name, os: @computer.os, scep: @computer.scep } }
